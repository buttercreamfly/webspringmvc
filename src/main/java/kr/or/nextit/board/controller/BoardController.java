...
public class BoardController {
	...
	public String boardView(
			...
			@PathVariable(value = "bo_seq_no", required = true) int bo_seq_no, Model model) throws Exception {
	...
	public String boardDelete(HttpSession session, @RequestParam("bo_seq_no") int bo_seq_no, Model model) {
